...
> 对应 JD 能力：配置表维护、基础数值调试、系统需求拆分、功能测试。
...
| JD 要求 | 本文档对应证据 |
|---------|----------------|
| 撰写系统策划案、规则说明、配置表 | 将天赋、敌人、能量参数拆为结构化字段 |
| 维护游戏配置数据 | 每条配置有 id、来源文档、状态和验收规则 |
| 基础数值调试 | 能量收益、超频消耗、敌人攻击节奏均可通过表格调整 |
| 功能测试和版本检查 | check_rule 字段记录每条配置的验证方式 |
